...
const updateBranchManager = async (req, res) => {
	try {
		const updatedBranchManager = await BranchManager.findByIdAndUpdate(req.params._id, { username: req.body.username, firstname: req.body.firstname, lastname: req.body.lastname, email: req.body.email, phonenumber: req.body.phonenumber }, {
